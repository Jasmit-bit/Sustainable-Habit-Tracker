...
| ANA-IT-13 | BarChart renders when data exists for that week | `Analytics.jsx` | Override mock supabase with some mock data | Chart should be visible on the page and show the summary for the data | Vitest confirms the chart header, and therefore the chart appears on the page | Pass |
...
| ANA-IT-15 | PieChart renders when data exists for that week | `Analytics.jsx` | Override mock supabase with some mock data | Chart should be visible on the page and show the summary for the data | Vitest confirms the chart header, and therefore the chart appears on the page | Pass |
